...
class FlightProgram:
    ...
    def generate_preset_table(self,root):
        ...
        df_new.sort_values(by=['SUCCESS_RATES'],ascending=True)
    ...
    def insert_table(self,df,root):
        ...
        for index,row in df.iterrows():
            self.tree.insert('', 'start', text=index,values = (row['DISTANCE'], row['UNIQUE_CARRIER_NAME'],row['ORIGIN_CITY_NAME'], row['DEST_CITY_NAME'], row['MONTH'], row['SUCCESS_RATES']) )
